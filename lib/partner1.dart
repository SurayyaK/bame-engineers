...
class PartnerOnePage extends StatefulWidget {
  @override
  _PartnerOnePageState createState() => _PartnerOnePageState();
}

class _PartnerOnePageState extends State<PartnerOnePage> {
